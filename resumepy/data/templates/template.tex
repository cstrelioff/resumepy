...
\draw[ColorTwo, line width=1.5] (0in, 0) -- (7.2in, 0);
\end{tikzpicture}
...
\vskip1.0em
\MySquare~\textbf{Additional Coursework}
\vskip0.5em
...
%{ block  work %}
\vskip1em
\MySquare~\textbf{Work Experience}
\vskip0.5em
...
%{- if projects %}
\vskip1em
\MySquare~\textbf{Projects \& Publications}
\vskip0.5em
