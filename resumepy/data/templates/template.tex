...
\node[header right] at (7.2in, -0.8em) {\large  %{{contact.email %}} };
\node[header right] at (7.2in, -2.4em) {\large  %{{online.website %}} };
...
\vskip0.5em
\begin{tikzpicture}[default picture]
\node[section header] (experience) {\Large Selected Work Experience};
